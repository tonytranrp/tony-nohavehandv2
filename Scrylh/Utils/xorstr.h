...
////////////////////////////////////////////////////////////////////
// Primary template
// Helper function to construct the index list at compile-time
template <size_t... Indices>
constexpr auto make_index_list(std::index_sequence<Indices...>) {
...
struct ConstructIndexList {
    using Result = decltype(make_index_list(std::make_index_sequence<N>{}));
};

template <size_t N>
using XorIndexList = typename ConstructIndexList<N>::Result;
// Partial specialization to stop the recursion when N is 0
template <>
