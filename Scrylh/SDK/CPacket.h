...
public:
	MobEquipmentPacket();
	MobEquipmentPacket(__int64 entityRuntimeId, C_ItemStack& item, int hotbarSlot, int inventorySlot);
...
public:
	...
	InventoryTransactionPacket(C_InventoryTransaction* transac) : InventoryTransactionPacket() {
	...
	C_InventoryTransaction* complexTransaction;  // 0x48
