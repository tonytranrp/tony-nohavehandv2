#include "CubeCraftSpeed.h"

CubeCraftSpeed::CubeCraftSpeed() : IModule(0x0, Category::MOVEMENT, "Speed bypass for CubeCraft") {
	registerFloatSetting("speed", &this->speedMod, 1, 0.3f, 2.5f);
	//this->registerBoolSetting("Fly", &this->isBypass, this->isBypass);
}
bool isBypass = false;
CubeCraftSpeed::~CubeCraftSpeed() {
}

const char* CubeCraftSpeed::getModuleName() {
	return ("CubeCraftSpeed");
}

void CubeCraftSpeed::onMove(C_MoveInputHandler* input) {
